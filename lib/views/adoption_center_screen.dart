...
final _listingsProvider =
    FutureProvider.family<List<AdoptionListing>, String>((ref, species) async {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text('Adopt ${listing.petName}',
              style: Theme.of(context).textTheme.headlineSmall),
          const SizedBox(height: 4),
          Text('${listing.shelterName}${listing.location != null ? ' · ${listing.location}' : ''}',
              style: TextStyle(
