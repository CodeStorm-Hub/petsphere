...
class CareGoalEditorModal extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CareGoalEditorModal> createState() => _CareGoalEditorModalState();
}
...
class _CareGoalEditorModalState extends ConsumerState<CareGoalEditorModal> {
  ...
  void initState() {
    ...
    final weightKg = 10.0; // Fallback, we'd ideally get this from the pet profile. Assuming 10kg for generic warnings if weight is missing.
    ...
    _baselineWater = CareCalculator.dailyWaterCups(species: species, weightKg: weightKg);
  ...
  bool get _hasExerciseWarning =>
      _exerciseGoal < _baselineExercise * 0.5 || _exerciseGoal > _baselineExercise * 2.0;
        ...
        child: Column(
          ...
          _buildGoalSection(
            ...
            slider: Slider(
              ...
              max: 20,
              divisions: 19,
              activeColor: _hasWaterWarning ? colorScheme.error : colorScheme.primary,
          ...
          _buildGoalSection(
            ...
            slider: Slider(
              ...
              max: 240,
              divisions: 24,
              activeColor: _hasExerciseWarning ? colorScheme.tertiary : colorScheme.secondary,
          ...
          FilledButton(
            ...
            onPressed: () {
              ref.read(petCareProvider.notifier).updateGoals(
