...
import '../repositories/community_group_repository.dart';
...
final _groupsProvider =
    FutureProvider.family<List<CommunityGroup>, String>((ref, category) async {
                        ...
                        onToggle: () async {
                          ...
                          if (groups[i].isMember) {
                            await communityGroupRepository
                                .leaveGroup(groups[i].id);
                          } else {
                            await communityGroupRepository
                                .joinGroup(groups[i].id);
                          }
...
class _CreateGroupSheet extends StatefulWidget {
  ...
  const _CreateGroupSheet(
      {required this.ownerId, required this.onCreated});
...
class _CreateGroupSheetState extends State<_CreateGroupSheet> {
  ...
  Future<void> _save() async {
    ...
    try {
      await communityGroupRepository.createGroup(CommunityGroup(
        id: '',
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['general', 'dogs', 'cats', 'birds', 'training', 'health', 'adoption']
