...
class _PetProfileScreenState extends ConsumerState<PetProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final gridTileCacheWidth =
        ((MediaQuery.sizeOf(context).width / 3) * pixelRatio).round();
    ...
    return Scaffold(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (isOwnerView) ...[
                                    ref
                                        .watch(
                                          ownerFollowerCountProvider(myUserId),
                                        )
                                        .when(
                                          data: (count) => _StatColumn(
                                            label: "Followers",
                                            value: "$count",
                                          ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: isOwnerView && (user?.bio?.isEmpty ?? true)
                                ...
                                : null,
                            fontStyle:
                                isOwnerView && (user?.bio?.isEmpty ?? true)
                                ? FontStyle.italic
                                : null,
                          ),
                        ),
                          ...
                          Wrap(
                            ...
                            children: [
                              _InfoChip(
                                icon: Icons.pets,
                                label:
                                    '${myOwnedPets.length} ${myOwnedPets.length == 1 ? 'Pet' : 'Pets'}',
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _InfoChip(
                                ...
                                label:
                                    '${selectedPet.age} ${selectedPet.age == 1 ? 'year' : 'years'} old',
                                color: const Color(0xFF4FC3F7),
                              ),
                          ...
                          children: [
                            Expanded(
                              child: OutlinedButton(
                                ...
                                child: Text(
                                  isOwnerView ? 'Edit Account' : 'Edit Profile',
                                ),
                              ),
                            ),
      ...
      floatingActionButton: !isOwnerView && selectedPet != null
          ? FloatingActionButton(
              heroTag: 'pet_profile_create_post_fab',
              onPressed: () =>
    ...
    return Container(
      ...
      child: CircleAvatar(
        ...
        child:
            ...
            : (!isOwnerView &&
                      (selectedPet == null ||
                          selectedPet.profileImageUrl.isEmpty)
