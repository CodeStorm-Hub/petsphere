...
class EmergencyCareScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EmergencyCareScreen> createState() => _EmergencyCareScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
          SliverAppBar.large(
            title: const Text('Emergency Care', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            actions: [
              IconButton.filledTonal(
                ...
                style: IconButton.styleFrom(backgroundColor: colorScheme.error.withAlpha(40)),
              ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text('Immediate Actions', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                      TextButton.icon(
                        onPressed: () {},
                  ...
                  _ActionGrid(),
                  const SizedBox(height: 32),
                  Text('24/7 Hotlines', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 16),
                  ...
                  const SizedBox(height: 32),
                  Text('Toxic Food Items', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 16),
                  _ToxicItemsList(),
      ...
      floatingActionButton: FloatingActionButton.large(
        ...
        child: const Column(
          ...
          children: [
            ...
            Text('SOS', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 1)),
          ],
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: colorScheme.error.withAlpha(60), blurRadius: 24, offset: const Offset(0, 10)),
        ],
      ),
      child: Row(
        children: [
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.qr_code_2_rounded, size: 48, color: Colors.black),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('$petName\'s Digital ID', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
                const SizedBox(height: 4),
                Text('Instant medical access for vets.', style: TextStyle(color: colorScheme.onSurfaceVariant, fontSize: 13, fontWeight: FontWeight.w500)),
              ],
            ),
          ),
          IconButton.filledTonal(
            ...
            style: IconButton.styleFrom(backgroundColor: colorScheme.primaryContainer.withAlpha(150)),
          ),
        ],
      ),
    );
          ...
          child: Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: colorScheme.errorContainer.withAlpha(100), borderRadius: BorderRadius.circular(20)),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(description, style: TextStyle(color: colorScheme.onSurfaceVariant, fontSize: 12, fontWeight: FontWeight.w500)),
                    const SizedBox(height: 6),
                    Text(phone, style: TextStyle(color: colorScheme.error, fontWeight: FontWeight.w900, fontSize: 15)),
                  ],
                ),
              ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  Text(action['title'] as String, style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 14)),
                ],
              ),
            ),
          ),
