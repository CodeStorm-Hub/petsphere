...
class LostAndFoundScreen extends ConsumerWidget {
  ...
  void _openReportSheet(BuildContext context, WidgetRef ref) {
    ...
    showModalBottomSheet(
      ...
      useSafeArea: true,
      builder: (_) => _ReportSheet(reporterId: auth.user!.id, onSaved: () {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text('No ${status == 'lost' ? 'lost' : 'found'} pet reports',
                ...
                if (report.lastSeenLocation != null) ...[
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                          child: Text(report.lastSeenLocation!,
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (isLost ? colorScheme.error : colorScheme.tertiary)
            .withAlpha(230),
        borderRadius: BorderRadius.circular(20),
      ),
      child: Row(
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                decoration: const InputDecoration(
                    labelText: 'Animal Type', border: OutlineInputBorder()),
