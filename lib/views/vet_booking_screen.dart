...
class _VetBookingScreenState extends ConsumerState<VetBookingScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final upcoming = healthState.upcomingAppointments;
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(vet['name'] as String,
                        style: const TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 16)),
                    Text(vet['clinic'] as String,
                        style: TextStyle(
...
class _VetBookingSheetState extends ConsumerState<_VetBookingSheet> {
  ...
  Future<void> _confirmBooking() async {
    ...
    await ref.read(healthProvider.notifier).upsertAppointment(appt);
            ...
            Row(
              children: [
                CircleAvatar(
                  radius: 30,
                  backgroundImage:
                      NetworkImage(widget.vet['image'] as String),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(widget.vet['name'] as String,
                          style: Theme.of(context).textTheme.titleLarge),
                      Text(widget.vet['clinic'] as String,
                          style: TextStyle(
                              color: colorScheme.onSurfaceVariant)),
                      Text(widget.vet['bio'] as String,
                          style: TextStyle(
                              fontSize: 12,
                              color: colorScheme.onSurfaceVariant)),
                    ],
