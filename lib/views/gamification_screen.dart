  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (stats == null) {
      return Scaffold(
        ...
        body: const Center(child: Text('No gamification stats yet. Start logging care tasks!')),
      );
    }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _BadgesGrid(unlocks: care.unlocks),
        ],
      ),
    );
  }
...
class _LevelCard extends StatelessWidget {
  ...
  const _LevelCard({required this.level, required this.totalPoints, required this.progress});
        ...
        children: [
          Row(
            children: [
              ...
              Text('30-Day Care Challenge', style: TextStyle(fontWeight: FontWeight.bold)),
              const Spacer(),
              Text('$progress / 30', style: TextStyle(color: colorScheme.primary, fontWeight: FontWeight.bold)),
            ],
          ),
            ...
            return Column(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isUnlocked ? colorScheme.primaryContainer : colorScheme.surfaceContainer,
                    shape: BoxShape.circle,
                    border: isUnlocked ? null : Border.all(color: colorScheme.outlineVariant),
                  ),
                  child: Opacity(
