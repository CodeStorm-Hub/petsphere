...
class PetMedication {
  ...
  Color get statusColor {
    switch (status) {
      case 'active':    return AppTheme.secondaryAccent;
...
class PetAllergy {
  ...
  Map<String, dynamic> toInsertJson() => {
    ...
    if (diagnosedOn != null) 'diagnosed_on': diagnosedOn!.toIso8601String().split('T').first,
    'is_active':    isActive,
    if (notes != null) 'notes': notes,
  };
}
...
class ParasitePrevention {
  ...
  String get productTypeLabel {
    switch (productType) {
      ...
      case 'flea_tick': return 'Flea & Tick';
      case 'heartworm': return 'Heartworm';
      case 'dewormer':  return 'Dewormer';
...
class DentalLog {
  ...
  final String cleaningType; // home_brushing|dental_chew|professional_cleaning|water_additive
  final String? notes;
  ...
  String get cleaningTypeLabel {
    switch (cleaningType) {
      case 'home_brushing':        return 'Home Brushing';
      case 'dental_chew':          return 'Dental Chew';
      case 'professional_cleaning':return 'Professional Cleaning';
      case 'water_additive':       return 'Water Additive';
      default:                     return cleaningType;
    }
  }

  IconData get cleaningIcon {
    switch (cleaningType) {
      case 'professional_cleaning': return Icons.medical_services;
      case 'dental_chew':           return Icons.cookie;
      case 'water_additive':        return Icons.water_drop;
