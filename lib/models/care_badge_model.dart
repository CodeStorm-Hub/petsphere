...
class PetCareGamification {
  ...
  Map<String, dynamic> toUpsertJson() => {
        ...
        'week_start_monday':
            weekStartMonday == null ? null : _fmtDate(weekStartMonday!),
        ...
        'last_30d_increment_on':
            last30dIncrementOn == null ? null : _fmtDate(last30dIncrementOn!),
        'daily_point_award_date':
            dailyPointAwardDate == null ? null : _fmtDate(dailyPointAwardDate!),
        ...
        'streak_freeze_reset_on':
            streakFreezeResetOn == null ? null : _fmtDate(streakFreezeResetOn!),
      };
}
