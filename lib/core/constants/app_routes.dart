class AppRoutes {
  ...
  static String petMedicalRecordsExportById(String id) =>
      '/pet/$id/medical_records/export';
  ...
  static String createStoryByPetId(String petId) =>
      '/create_story?petId=$petId';
  static String lostFoundDetailById(String reportId) =>
      '/lost_and_found/$reportId';
