...
class CareCalculator {
  ...
  static int mealsPerDay({required String species, required String ageBand}) {
  ...
  static int kcalPerMeal({required int dailyKcal, required int numMeals}) {
