...
class PetCareLog {
  ...
  bool operator ==(Object other) =>
      ...
      other is PetCareLog &&
          ...
          breakfastFed == other.breakfastFed &&
          dinnerFed == other.dinnerFed &&
          breakfastKcal == other.breakfastKcal &&
          dinnerKcal == other.dinnerKcal &&
          breakfastFood == other.breakfastFood &&
          dinnerFood == other.dinnerFood &&
          snackFed == other.snackFed &&
          snackKcal == other.snackKcal &&
          snackFood == other.snackFood &&
          treatsCount == other.treatsCount &&
          treatsKcal == other.treatsKcal &&
          waterCups == other.waterCups &&
          tasks == other.tasks &&
          mood == other.mood &&
          dailyCalorieGoal == other.dailyCalorieGoal &&
          dailyWaterGoalCups == other.dailyWaterGoalCups &&
          dailyExerciseGoalMinutes == other.dailyExerciseGoalMinutes;
  ...
  int get hashCode =>
      ...
      petId.hashCode ^
      logDate.hashCode ^
      breakfastFed.hashCode ^
      dinnerFed.hashCode ^
      breakfastKcal.hashCode ^
      dinnerKcal.hashCode ^
      breakfastFood.hashCode ^
      dinnerFood.hashCode ^
      snackFed.hashCode ^
      snackKcal.hashCode ^
      snackFood.hashCode ^
      treatsCount.hashCode ^
      treatsKcal.hashCode ^
      waterCups.hashCode ^
      tasks.hashCode ^
      mood.hashCode ^
