...
final petExpenseRepositoryProvider = Provider<PetExpenseRepository>(
  (ref) => PetExpenseRepository(),
);

final petExpenseRepository =
    PetExpenseRepository(); // Keep for legacy if needed, but prefer provider
