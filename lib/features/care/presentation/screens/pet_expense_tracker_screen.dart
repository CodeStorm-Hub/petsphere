...
import 'package:petsphere/features/care/presentation/controllers/pet_expense_controller.dart';
            ...
            ElevatedButton(
              onPressed: () async {
                if (_formKey.currentState!.validate()) {
                  await ref
                      .read(petExpenseProvider.notifier)
                      .addExpense(
          ...
          FilledButton(
            onPressed: () async {
              ...
              if (newBudget != null) {
                ...
                if (activePet != null) {
                  await ref.read(petProvider.notifier).updatePet(activePet.id, {
