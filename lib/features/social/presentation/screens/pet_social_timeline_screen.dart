...
class PetSocialTimelineScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PetSocialTimelineScreen> createState() =>
      _PetSocialTimelineScreenState();
}

class _PetSocialTimelineScreenState
    extends ConsumerState<PetSocialTimelineScreen> {
  @override
...
class _TimelineList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final events = [
      {
        'title': 'First Visit to the Beach!',
        'date': 'Oct 20, 2024',
        'type': 'photo',
        'desc': 'He loved the waves! No fear at all!',
      },
      {
        'title': 'Expert Agility Level',
        'date': 'Sep 25, 2024',
        'type': 'achievement',
        'desc': 'Completed the advanced course in record time.',
      },
      {
        'title': 'Vaccination Day',
        'date': 'Aug 02, 2024',
        'type': 'health',
        'desc': 'Annual checkup done. Perfectly healthy.',
      },
      {
        'title': 'New Best Friend',
        'date': 'Jul 15, 2024',
        'type': 'milestone',
        'desc': 'Met Luna at the park today.',
      },
      {
        'title': 'Adoption Anniversary',
        'date': 'Jun 12, 2024',
        'type': 'milestone',
        'desc': 'One year of pure happiness.',
      },
    ];
