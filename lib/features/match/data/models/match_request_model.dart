...
class MatchRequestModel {
  ...
  factory MatchRequestModel.fromJson(Map<String, dynamic> json) {
    ...
    return MatchRequestModel(
      ...
      receiverPet: receiverJson != null
          ? PetModel.fromJson(receiverJson)
          : null,
    );
  }
  final String id;
  ...
  bool operator ==(Object other) =>
      ...
      other is MatchRequestModel &&
          runtimeType == other.runtimeType &&
          id == other.id &&
          senderPetId == other.senderPetId &&
          receiverPetId == other.receiverPetId &&
          status == other.status &&
          createdAt == other.createdAt &&
          senderPet == other.senderPet &&
          receiverPet == other.receiverPet;

  @override
  int get hashCode =>
      id.hashCode ^
      senderPetId.hashCode ^
      receiverPetId.hashCode ^
      status.hashCode ^
      createdAt.hashCode ^
      senderPet.hashCode ^
      receiverPet.hashCode;
}
