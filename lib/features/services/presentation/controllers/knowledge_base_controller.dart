...
final featuredArticlesProvider = FutureProvider<List<KnowledgeArticle>>((
  ref,
) async {
  return ref.watch(knowledgeBaseRepositoryProvider).fetchFeaturedArticles();
});

final knowledgeBaseArticlesProvider = FutureProvider<List<KnowledgeArticle>>((
  ref,
) async {
  ...
  return ref
      ...
      .fetchArticles(category: category, query: query);
});

final knowledgeBaseRepositoryProvider = Provider(
  (ref) => knowledgeBaseRepository,
);
