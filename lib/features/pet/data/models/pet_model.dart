class PetModel {
  ...
  Map<String, dynamic> toJson() => {
    ...
    if (dailyWaterGoalCups != null) 'daily_water_goal_cups': dailyWaterGoalCups,
  ...
  bool operator ==(Object other) =>
      ...
      other is PetModel &&
          ...
          images == other.images &&
          isPublicOwner == other.isPublicOwner &&
          isBreedingListed == other.isBreedingListed &&
          isVerified == other.isVerified &&
          isVaccinated == other.isVaccinated &&
          isCareListed == other.isCareListed &&
  ...
  int get hashCode =>
      ...
      images.hashCode ^
      isPublicOwner.hashCode ^
      isBreedingListed.hashCode ^
      isVerified.hashCode ^
      isVaccinated.hashCode ^
      isCareListed.hashCode ^
